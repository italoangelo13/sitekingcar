...
<body>
    <div class="container-fluid">
        ...
        <div id="PainelPrinc" class="display-show">
            <div class="row" style="margin-top:5px;">
                <div class="col-lg-12">
                    <button class="btn btn-success" onclick="AlternaPainel('painelCad', 'PainelPrinc')"><i class="icone-plus"></i> Cadastrar Carro</button>
                </div>
            </div>
            ...
            <form action="" method="post">
                <div class="row" style="margin-top: 5px;">
                    <div class="col-lg-12">
                        <div class=" row box-pesquisa bg-secondary">
                            <div class="col-lg-9">
        ...
        <div id="painelCad" class="display-hide">
            <div class="row">
                <div class="col-lg-12">
                    <form action="" method="post">
                        <div class="btn-group">
                        <button class="btn btn-dark" onclick="AlternaPainel('PainelPrinc', 'painelCad')"><i class="fas fa-angle-left"></i> Voltar</button>
                        <button type="reset" class="btn btn-danger"><i class="fas fa-backspace"></i> Limpar</button>
