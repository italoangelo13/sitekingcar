    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="vertical-menu">
                ...
                <a href="#" target="conteudo"><i class="icone-user"></i>        <label>Usuários</label></a>
                <a href="CrudCarros.php" target="conteudo"><i class="fas fa-car"></i>        <label>Carros  </label></a>
                <a href="#" target="conteudo"><i class="icone-newspaper-2"></i> <label>Publicidades</label></a>
                <a href="#" target="conteudo"><i class="icone-question"></i>    <label>Sobre   </label></a>
            </div>
            </div>
